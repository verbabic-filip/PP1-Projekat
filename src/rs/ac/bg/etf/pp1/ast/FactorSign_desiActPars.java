...
public class FactorSign_desiActPars extends FactorSign {

    private Designator Designator;
    private ActParsList ActParsList;

    public FactorSign_desiActPars (Designator Designator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorSign_desiActPars(\n");
